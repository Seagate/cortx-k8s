...
![Version: 0.1.0](https://img.shields.io/badge/Version-0.1.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.0.0-879](https://img.shields.io/badge/AppVersion-2.0.0--879-informational?style=flat-square)
...
| global.cortx.image.registry | string | `""` | CORTX Docker image registry. Overrides CORTX component `image.registry`. |
| global.cortx.image.tag | string | `""` | CORTX image tag. Overrides CORTX component `image.tag`. |
| global.imageRegistry | string | `""` | Global Docker image registry. Overrides CORTX component `image.registry` and sub-charts (except Consul). |
