...
function deployCortxControl()
{
    ...
    helm install "cortx-control-$namespace" cortx-cloud-helm-pkg/cortx-control \
        ...
        --set cortxcontrol.resource_allocation.setup.resources.requests.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_control.setup.resources.requests.cpu') \
        --set cortxcontrol.resource_allocation.setup.resources.requests.memory=$(extractBlock 'solution.common.resource_allocation.cortx_control.setup.resources.requests.memory') \
        --set cortxcontrol.resource_allocation.setup.resources.limits.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_control.setup.resources.limits.cpu') \
        --set cortxcontrol.resource_allocation.setup.resources.limits.memory=$(extractBlock 'solution.common.resource_allocation.cortx_control.setup.resources.limits.memory') \
        --set cortxcontrol.resource_allocation.motr_fsm.resources.requests.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_control.motr_fsm.resources.requests.cpu') \
        --set cortxcontrol.resource_allocation.motr_fsm.resources.requests.memory=$(extractBlock 'solution.common.resource_allocation.cortx_control.motr_fsm.resources.requests.memory') \
        --set cortxcontrol.resource_allocation.motr_fsm.resources.limits.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_control.motr_fsm.resources.limits.cpu') \
        --set cortxcontrol.resource_allocation.motr_fsm.resources.limits.memory=$(extractBlock 'solution.common.resource_allocation.cortx_control.motr_fsm.resources.limits.memory') \
        --set cortxcontrol.resource_allocation.utils_message.resources.requests.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_control.utils_message.resources.requests.cpu') \
        --set cortxcontrol.resource_allocation.utils_message.resources.requests.memory=$(extractBlock 'solution.common.resource_allocation.cortx_control.utils_message.resources.requests.memory') \
        --set cortxcontrol.resource_allocation.utils_message.resources.limits.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_control.utils_message.resources.limits.cpu') \
        --set cortxcontrol.resource_allocation.utils_message.resources.limits.memory=$(extractBlock 'solution.common.resource_allocation.cortx_control.utils_message.resources.limits.memory') \
        --set cortxcontrol.resource_allocation.bgscheduler.resources.requests.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_control.bgscheduler.resources.requests.cpu') \
        --set cortxcontrol.resource_allocation.bgscheduler.resources.requests.memory=$(extractBlock 'solution.common.resource_allocation.cortx_control.bgscheduler.resources.requests.memory') \
        --set cortxcontrol.resource_allocation.bgscheduler.resources.limits.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_control.bgscheduler.resources.limits.cpu') \
        --set cortxcontrol.resource_allocation.bgscheduler.resources.limits.memory=$(extractBlock 'solution.common.resource_allocation.cortx_control.bgscheduler.resources.limits.memory') \
        --set cortxcontrol.resource_allocation.csm_agent.resources.requests.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_control.csm_agent.resources.requests.cpu') \
        --set cortxcontrol.resource_allocation.csm_agent.resources.requests.memory=$(extractBlock 'solution.common.resource_allocation.cortx_control.csm_agent.resources.requests.memory') \
        --set cortxcontrol.resource_allocation.csm_agent.resources.limits.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_control.csm_agent.resources.limits.cpu') \
        --set cortxcontrol.resource_allocation.csm_agent.resources.limits.memory=$(extractBlock 'solution.common.resource_allocation.cortx_control.csm_agent.resources.limits.memory') \
        --set namespace=$namespace \
        -n $namespace
...
function deployCortxData()
{
    ...
    for i in "${!node_selector_list[@]}"; do
        ...
        helm install "cortx-data-$node_name-$namespace" cortx-cloud-helm-pkg/cortx-data \
            ...
            --set cortxdata.resource_allocation.setup.resources.requests.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_data.setup.resources.requests.cpu') \
            --set cortxdata.resource_allocation.setup.resources.requests.memory=$(extractBlock 'solution.common.resource_allocation.cortx_data.setup.resources.requests.memory') \
            --set cortxdata.resource_allocation.setup.resources.limits.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_data.setup.resources.limits.cpu') \
            --set cortxdata.resource_allocation.setup.resources.limits.memory=$(extractBlock 'solution.common.resource_allocation.cortx_data.setup.resources.limits.memory') \
            --set cortxdata.resource_allocation.hax.resources.requests.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_data.hax.resources.requests.cpu') \
            --set cortxdata.resource_allocation.hax.resources.requests.memory=$(extractBlock 'solution.common.resource_allocation.cortx_data.hax.resources.requests.memory') \
            --set cortxdata.resource_allocation.hax.resources.limits.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_data.hax.resources.limits.cpu') \
            --set cortxdata.resource_allocation.hax.resources.limits.memory=$(extractBlock 'solution.common.resource_allocation.cortx_data.hax.resources.limits.memory') \
            ...
            --set cortxdata.resource_allocation.motr_io.resources.requests.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_data.motr_io.resources.requests.cpu') \
            --set cortxdata.resource_allocation.motr_io.resources.requests.memory=$(extractBlock 'solution.common.resource_allocation.cortx_data.motr_io.resources.requests.memory') \
            --set cortxdata.resource_allocation.motr_io.resources.limits.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_data.motr_io.resources.limits.cpu') \
            --set cortxdata.resource_allocation.motr_io.resources.limits.memory=$(extractBlock 'solution.common.resource_allocation.cortx_data.motr_io.resources.limits.memory') \
            --set namespace=$namespace \
            -n $namespace
    done
...
function deployCortxServer()
{
    ...
    for i in "${!node_selector_list[@]}"; do
        ...
        helm install "cortx-server-$node_name-$namespace" cortx-cloud-helm-pkg/cortx-server \
            ...
            --set cortxserver.resource_allocation.setup.resources.requests.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_server.setup.resources.requests.cpu') \
            --set cortxserver.resource_allocation.setup.resources.requests.memory=$(extractBlock 'solution.common.resource_allocation.cortx_server.setup.resources.requests.memory') \
            --set cortxserver.resource_allocation.setup.resources.limits.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_server.setup.resources.limits.cpu') \
            --set cortxserver.resource_allocation.setup.resources.limits.memory=$(extractBlock 'solution.common.resource_allocation.cortx_server.setup.resources.limits.memory') \
            --set cortxserver.resource_allocation.haproxy.resources.requests.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_server.haproxy.resources.requests.cpu') \
            --set cortxserver.resource_allocation.haproxy.resources.requests.memory=$(extractBlock 'solution.common.resource_allocation.cortx_server.haproxy.resources.requests.memory') \
            --set cortxserver.resource_allocation.haproxy.resources.limits.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_server.haproxy.resources.limits.cpu') \
            --set cortxserver.resource_allocation.haproxy.resources.limits.memory=$(extractBlock 'solution.common.resource_allocation.cortx_server.haproxy.resources.limits.memory') \
            --set cortxserver.resource_allocation.authserver.resources.requests.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_server.authserver.resources.requests.cpu') \
            --set cortxserver.resource_allocation.authserver.resources.requests.memory=$(extractBlock 'solution.common.resource_allocation.cortx_server.authserver.resources.requests.memory') \
            --set cortxserver.resource_allocation.authserver.resources.limits.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_server.authserver.resources.limits.cpu') \
            --set cortxserver.resource_allocation.authserver.resources.limits.memory=$(extractBlock 'solution.common.resource_allocation.cortx_server.authserver.resources.limits.memory') \
            --set cortxserver.resource_allocation.s3server.resources.requests.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_server.s3server.resources.requests.cpu') \
            --set cortxserver.resource_allocation.s3server.resources.requests.memory=$(extractBlock 'solution.common.resource_allocation.cortx_server.s3server.resources.requests.memory') \
            --set cortxserver.resource_allocation.s3server.resources.limits.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_server.s3server.resources.limits.cpu') \
            --set cortxserver.resource_allocation.s3server.resources.limits.memory=$(extractBlock 'solution.common.resource_allocation.cortx_server.s3server.resources.limits.memory') \
            --set cortxserver.resource_allocation.hax.resources.requests.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_server.hax.resources.requests.cpu') \
            --set cortxserver.resource_allocation.hax.resources.requests.memory=$(extractBlock 'solution.common.resource_allocation.cortx_server.hax.resources.requests.memory') \
            --set cortxserver.resource_allocation.hax.resources.limits.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_server.hax.resources.limits.cpu') \
            --set cortxserver.resource_allocation.hax.resources.limits.memory=$(extractBlock 'solution.common.resource_allocation.cortx_server.hax.resources.limits.memory') \
            --set cortxserver.resource_allocation.bgworker.resources.requests.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_server.bgworker.resources.requests.cpu') \
            --set cortxserver.resource_allocation.bgworker.resources.requests.memory=$(extractBlock 'solution.common.resource_allocation.cortx_server.bgworker.resources.requests.memory') \
            --set cortxserver.resource_allocation.bgworker.resources.limits.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_server.bgworker.resources.limits.cpu') \
            --set cortxserver.resource_allocation.bgworker.resources.limits.memory=$(extractBlock 'solution.common.resource_allocation.cortx_server.bgworker.resources.limits.memory') \
            --set namespace=$namespace \
            -n $namespace
    done
...
function deployCortxHa()
{
    ...
    helm install "cortx-ha-$namespace" cortx-cloud-helm-pkg/cortx-ha \
        ...
        --set cortxha.resource_allocation.setup.resources.requests.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_ha.setup.resources.requests.cpu') \
        --set cortxha.resource_allocation.setup.resources.requests.memory=$(extractBlock 'solution.common.resource_allocation.cortx_ha.setup.resources.requests.memory') \
        --set cortxha.resource_allocation.setup.resources.limits.cpu=$(extractBlock 'solution.common.resource_allocation.cortx_ha.setup.resources.limits.cpu') \
        --set cortxha.resource_allocation.setup.resources.limits.memory=$(extractBlock 'solution.common.resource_allocation.cortx_ha.setup.resources.limits.memory') \
